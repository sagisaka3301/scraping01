...
# 現在のパス
now_path = "C:\\Users\\ks122\\Python\\practice2\\"
# 作成したいExcelのファイル名を指定
efile_name = "test.xlsx"
efile_path = now_path + efile_name
# sheetの名前を指定
esheet_name1 = "test_sheet1"
# 対象サイトのリンク
web_link = "https://www.onefc.com/jp/athletes/"
# 対象のhtmlタグ
tag = 'ul'
# 対象のクラス
class_name = "athlete-name"
# 「もっとみる」等ボタンがある際、対象ボタンのクラス名
view_more = 'btn-load-more'
